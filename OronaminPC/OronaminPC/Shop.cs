...
namespace OronaminPC
{
    public class Shop
    {
        ...
        public Shop()
        {
            ...
            equipment.Add(new Item("게이밍 키보드", Item.Type.키보드, "역시 돈도 재능이다", 4000, 0, 30, 0, 0));
            ...
            potion.Add(new Item("콜  라", Item.Type.음료수, "PC방 콜라 국룰이지", 300, 3, 1, 0, 0));
            potion.Add(new Item("핫식스", Item.Type.음료수, "하루종일 게임 쌉가능", 500, 5, 3, 0, 0));
            potion.Add(new Item("레드불", Item.Type.음료수, "이거슨 합법적 각성제", 1200, 8, 8, 0, 0));
            potion.Add(new Item("박카스", Item.Type.음료수, "심장이 도킹도킹!!", 1800, 12, 15, 0, 0));
            potion.Add(new Item("얼박사", Item.Type.음료수, "맛있는데 힘까지 넘쳐", 3000, 15, 20, 0, 0));
        }
